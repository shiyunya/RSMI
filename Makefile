...
# for linux
ifeq ($(TYPE), GPU)
	INCLUDE = -I ../libtorch-cxx11-abi-shared-with-deps-1.4.0+cpu/libtorch_gpu/include -I ../libtorch-cxx11-abi-shared-with-deps-1.4.0+cpu/libtorch_gpu/include/torch/csrc/api/include
	LIB +=-L ../libtorch-cxx11-abi-shared-with-deps-1.4.0+cpu/libtorch_gpu/lib -ltorch -lc10 -lpthread
	FLAG = -Wl,-rpath= ../libtorch-cxx11-abi-shared-with-deps-1.4.0+cpu/libtorch_gpu/lib
else
...
# INCLUDE = -I/mnt/d/libtorch-cxx11-abi-shared-with-deps-1.4.0+cpu/libtorch/include -I/mnt/d/libtorch-cxx11-abi-shared-with-deps-1.4.0+cpu/libtorch/include/torch/csrc/api/include
...
# g++ -O3 -std=c++14 -o Exp Exp.o utils/FileReader.o utils/ExpRecorder.o utils/Constants.o utils/FileWriter.o entities/Mbr.o entities/NodeExtend.o entities/NonLeafNode.o entities/LeafNode.o entities/Node.o entities/Point.o curves/hilbert.o curves/z.o curves/hilbert4.o -I/mnt/d/libtorch-cxx11-abi-shared-with-deps-1.4.0+cpu/libtorch/include -I/mnt/d/libtorch-cxx11-abi-shared-with-deps-1.4.0+cpu/libtorch/include/torch/csrc/api/include -I/mnt/d//boost_1_73_0 -L/mnt/d/libtorch-cxx11-abi-shared-with-deps-1.4.0+cpu/libtorch/lib -ltorch -lc10 -lpthread -Wl,-rpath=/mnt/d/libtorch-cxx11-abi-shared-with-deps-1.4.0+cpu/libtorch/lib